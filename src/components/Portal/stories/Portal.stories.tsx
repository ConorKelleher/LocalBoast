...
import PortalDemo from "../stories/demos/PortalDemo"
...
<h3 style="margin-bottom: -10px">Demo</h3>`.replace("https://localboast.com/docs?path", "?path"),
  ...
  tags: ["autodocs"],
} as Meta<typeof PortalDemo>

if (storyConfig.metaMutations) {
  meta = merge(meta, storyConfig.metaMutations as Meta<typeof PortalDemo>)
}
