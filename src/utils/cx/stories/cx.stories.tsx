...
import CxDemo from "../stories/demos/CxDemo"
...
<h3 style="margin-bottom: -10px">Demo</h3>`,
  ...
  tags: ["autodocs"],
} as Meta<typeof CxDemo>

if (storyConfig.metaMutations) {
  meta = merge(meta, storyConfig.metaMutations as Meta<typeof CxDemo>)
}

export default meta

type Story = StoryObj<typeof CxDemo>
