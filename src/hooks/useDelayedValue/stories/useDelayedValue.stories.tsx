...
import UseDelayedValueDemo from "../stories/demos/UseDelayedValueDemo"
import storyConfig from "./config"

let meta = {
  title: "Hooks/useDelayedValue",
  component: UseDelayedValueDemo,
  parameters: {
    layout: "centered",
    docs: {
      description: {
...
<h3 style="margin-bottom: -10px">Demo</h3>`.replace("https://localboast.com/docs?path", "?path"),
  ...
  tags: ["autodocs"],
} as Meta<typeof UseDelayedValueDemo>

if (storyConfig.metaMutations) {
  meta = merge(meta, storyConfig.metaMutations as Meta<typeof UseDelayedValueDemo>)
}

export default meta

type Story = StoryObj<typeof UseDelayedValueDemo>

export const DelayedValue: Story = {
  args: {
    "value": "Change Me"
  }
}
