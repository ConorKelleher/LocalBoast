...
import UseHapticDemo from "../stories/demos/UseHapticDemo"
import storyConfig from "./config"

let meta = {
  title: "Hooks/useHaptic",
  component: UseHapticDemo,
  parameters: {
    layout: "centered",
    docs: {
      description: {
...
<h3 style="margin-bottom: -10px">Demo</h3>`.replace("https://localboast.com/docs?path", "?path"),
  ...
  tags: ["autodocs"],
} as Meta<typeof UseHapticDemo>

if (storyConfig.metaMutations) {
  meta = merge(meta, storyConfig.metaMutations as Meta<typeof UseHapticDemo>)
}
