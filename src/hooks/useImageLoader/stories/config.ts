...
const brokenURL = "ata:image/png;base64,thisisbroken"
...
export default {
  ...
  stories: [
    { name: "Working", args: { src: smileyURL, fallbackSrc: "" } },
    { name: "Broken", args: { src: brokenURL, fallbackSrc: "" } },
    {
      name: "BrokenWithFallback",
      args: { src: brokenURL, fallbackSrc: smileyURL },
    },
  ],
} as StoryConfig
