...
import UseLocalStorageDemo from "../stories/demos/UseLocalStorageDemo"
...
<h3 style="margin-bottom: -10px">Demo</h3>`.replace("https://localboast.com/docs?path", "?path"),
  ...
  tags: ["autodocs"],
} as Meta<typeof UseLocalStorageDemo>

if (storyConfig.metaMutations) {
  meta = merge(meta, storyConfig.metaMutations as Meta<typeof UseLocalStorageDemo>)
}
...
export const StringExample: Story = {
  args: {
    "demoType": "string"
  }
}
...
export const TypedExample: Story = {
  args: {
    "demoType": "typed"
  }
}
