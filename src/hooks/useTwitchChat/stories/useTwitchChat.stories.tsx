...
import UseTwitchChatDemo from "../stories/demos/UseTwitchChatDemo"
import storyConfig from "./config"

let meta = {
  title: "Hooks/useTwitchChat",
  component: UseTwitchChatDemo,
  parameters: {
    layout: "centered",
    docs: {
      description: {
...
<h3 style="margin-bottom: -10px">Demo</h3>`.replace("https://localboast.com/docs?path", "?path"),
  ...
  tags: ["autodocs"],
} as Meta<typeof UseTwitchChatDemo>

if (storyConfig.metaMutations) {
  meta = merge(meta, storyConfig.metaMutations as Meta<typeof UseTwitchChatDemo>)
}

export default meta

type Story = StoryObj<typeof UseTwitchChatDemo>

export const TwitchChat: Story = {
  args: {
    "botId": "7g4xkdxusodkut4ykeocfhci6grf6s"
  }
}
