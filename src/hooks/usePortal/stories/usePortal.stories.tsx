...
import UsePortalDemo from "../stories/demos/UsePortalDemo"
import storyConfig from "./config"

let meta = {
  title: "Hooks/usePortal",
  component: UsePortalDemo,
  parameters: {
    layout: "centered",
    docs: {
      description: {
...
<h3 style="margin-bottom: -10px">Demo</h3>`.replace("https://localboast.com/docs?path", "?path"),
  ...
  tags: ["autodocs"],
} as Meta<typeof UsePortalDemo>

if (storyConfig.metaMutations) {
  meta = merge(meta, storyConfig.metaMutations as Meta<typeof UsePortalDemo>)
}

export default meta

type Story = StoryObj<typeof UsePortalDemo>
